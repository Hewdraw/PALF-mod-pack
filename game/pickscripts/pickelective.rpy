...
menu:
    ">Go to [_return] class":
            ...
            python:
                ...
                for i, student in enumerate(GetStudents(classtype) | {"Ethan"}):
                    ...
                    if (student != "iono"):
                        ...
                        renpy.show(GetCharacterSprite("iono", 0, True, "surprisedbrow talking2mouth", False), [Transform(xpos=((i + 1) / (len(GetStudents(classtype)) + 2)))])
        ...
        label classbunnyrecruit:

        if (IsAfter(6, 6, 2004) and IsBefore(12, 6, 2004)):
            python:
                bunnyrecruits = []
                for char in GetStudents(classtype):
            ...
            if (len(bunnyrecruits) > 0):
                ...
                menu:
                    "Yes.":
                        call BunnyRecruit(classchar, True) from _call_BunnyRecruit_2

                    "No.":
                        jump classbunnyrecruit
