label Nessa1:
    ...
    nessa @talking2mouth "Nah."

    red @confused "But... your outfit?"

    nessa @talking2mouth "Yeah, I just wear this."
    nessa @happy "Pretty hot, right?"

    red @happy "I mean... yeah."

    nessa @talking2mouth "Life's too short to not be as hot as you can. I've probably only got another... what, ten years of this?"
    ...
    if (not IsBefore(1, 5, 2004)):
        ...
        nessa @talking2mouth "Why wouldn't it be?"

        red @sadbrow talking2mouth "I mean, the whole Frienergy thing..."

        nessa @closedbrow talking2mouth "It's whatever. Old news, at this point."

        red @surprised "Really?"

        nessa @talking2mouth "I believed your speech. Most other people probably did as well."
        nessa @talking2mouth "...Hearing Sabrina's thoughts affected me way more than anything I learned about you."
    ...
    if (not HasEvent("Nessa", "DateDeny")):
        ...
        nessa @talking2mouth "So. You wanted to get to know me. Any particular place you wanted to go to do that?"
    ...
    nessa @closedbrow talking2mouth "Alright, I'm down. This is something new, at least."
    ...
    if (not HasEvent("Nessa", "DateDeny")):
        ...
        nessa @talking2mouth "Well, it wouldn't have been an instant turn-off, but yeah. I'm pretty used to those kinds of dates."
    ...
    if (not HasEvent("Nessa", "DateDeny")):
        nessa @talking2mouth "Just ask. We're on a date."
    else:
        nessa @talking2mouth "That's why we're here."
    ...
    nessa @talking2mouth "You think I should have higher standards?"
    ...
    nessa @talking2mouth "Yeah, maybe."
    nessa @closedbrow talking2mouth "My standards for getting a second date are pretty high, though. I guess maybe my cutoff point is just later than it would be for others."
    ...
    nessa @talking2mouth "Yeah. Being a Champion is a short-term goal. What does being a Champion let you do?"
    ...
    nessa @talking2mouth "Yeah. Friend of mine."
    ...
    nessa @talking2mouth "Yeah. He became Champion five years ago, and has never lost a battle since."
    ...
    nessa @talking2mouth "Yeah. Our group of friends. We used to call ourselves the Galarian Stars."
    nessa @sad "I was the youngest. The sensible one, the one who kept us all grounded."
    nessa @closedbrow talking2mouth "Sonia was next. She was the granddaughter of a Pokémon Professor. Bit of a ditz, no self-esteem, but the smartest girl I know."
    nessa @talking2mouth "Then there was Raihan. He always used to call me 'Lil Nessie.' An arrogant blowhard, but... he lifted you up. Butted heads with Leon every chance he got."
    nessa @talking2mouth "And... Leon was the oldest of us. He was pants with directions, but wherever he looked, he saw the stars, and followed them."
    ...
    nessa @talking2mouth "They were just all waiting for me to become eighteen, then we'd take the Gym Challenge together."
    ...
    nessa -sad @talking2mouth "I wasn't going to ask him to wait for me, obviously. So we changed the plan."
    nessa @closedbrow talking2mouth "Well, Leon became Champion within the year."
    nessa @talking2mouth "When a new Galarian Champion is crowned, they usually immediately endorse the person they feel is most likely to unseat them. It's a tradition."
    nessa @closedbrow talking2mouth "So Leon endorsed Raihan, of course. Raihan apologized to Sonia and I, but set off on his challenge."

    red @talking2mouth "He didn't make it to Champion, though."

    nessa @talking2mouth "No. But he managed to make it right up to the league, eventually securing the eighth major league Gym Leader spot."
    nessa @talking2mouth "So, at that point, we figured that he could endorse Sonia, and then Sonia could endorse me."

    pause 1.0

    nessa @talking2mouth "Sonia couldn't make it. She dropped out after the fifth Gym."

    red @surprised "Oh, geez!"

    nessa @talking2mouth "We knew that the fifth Gym Leader was retiring soon, so we thought maybe Sonia could take over there, like Raihan did the eighth."
    nessa @talking2mouth "Trainer schools aren't really a thing in Galar. Most trainers just start their journeys and learn as they go. But we learned about Kobukan Academy, and heard it was a great place to get practical experience."

    if (IsBefore(20, 4, 2004)):
        nessa @talking2mouth "So Leon paid for her to go to Kobukan. She was here just last year, actually."
        ...
        nessa @talking2mouth "Yeah. She sent each of us hand-written letters apologizing for her failures, and then cut communications with us. Doesn't even respond to our texts."
        nessa @sad "God knows where she's gone."

        red @sad "Oh... I'm sorry to hear that."

    else:
        nessa @talking2mouth "So Leon paid for her to go to Kobukan. And... well, you already know. She dropped out of that, too."
        nessa @talking2mouth "She sent each of us hand-written letters apologizing for her failures, and then cut communications with us. Didn't even respond to our texts."
    ...
    nessa @talking2mouth "Yeah. Well, I figured I wasn't going to be getting an endorsement any time soon from either Leon or Raihan, so I'd just try my own hand at this Kobukan thing."

    red @surprised "Why wouldn't they endorse you?"

    nessa @talking2mouth "I was a public figure, so were they. It was common knowledge that we were all friends before Leon ever became Champion."
    nessa @closedbrow talking2mouth "Wouldn't look good if the Champion was endorsing unproven trainers, just 'cause they were friends." 
    nessa @talking2mouth "Raihan could {i}always{/i} hold his own against Leon."
    ...
    nessa @talking2mouth "The chain could've worked, though. Leon, through Raihan, through Sonia, to me, would have been enough degrees of separation."
    ...
    nessa -closedbrow -angrymouth frownmouth @talking2mouth "...Yeah. So... that's kinda the state of the Galarian Stars, now."
    nessa @talking2mouth "One got everything he wanted. One is still fighting for it. One disappeared. And I'm just starting my journey after everyone I care about is already finished."

    red "{w=0.5}.{w=0.5}.{w=0.5}."
    red @talking2mouth "Are you sure?"

    nessa @talking2mouth "What do you mean?"

    red @talkingmouth "Like, are you sure they're finished?"

    nessa @closedbrow talking2mouth "Um... pretty sure. Leon didn't really have a goal beyond becoming Champion."
    nessa @talking2mouth "Raihan's going to try and beat him, but that's kinda never happening."
    ...
    nessa -frownmouth @talking2mouth "But I don't know who'd bother telling it. 'News flash: Nothing has changed.' Boring, right?"
    ...
    nessa @talking2mouth "...So you're disagreeing with me?"

    red @sadbrow talkingmouth "Guess I am."

    if (not HasEvent("Nessa", "DateDeny")):
        nessa @happy "Good. Most dates just yes-man their way through."
        nessa @talking2mouth "Of course, most dates don't hear the whole Galarian Star shpiel..."
    else:
        nessa @closedbrow talking2mouth "First you turn me down for a date, then you disagree with me... you're full of surprises."

    $ lowertime = timeOfDay.lower()
    if (lowertime in ["morning", "evening"]):
        nessa @sad "Guess I'm off my game. It's been a weird [lowertime]."
    else:
        nessa @sad "Guess I'm off my game. It's been a weird day."
    ...
    nessa @talking2mouth "I'll think on that."

    if (not HasEvent("Nessa", "DateDeny")):
        red @happy "Cool. So what're my chances of another date?"

        nessa @closedbrow talking2mouth "...Well, I liked our conversation. Let's actually {i}do something{/i} next time, though."
        ...
        nessa @closedbrow talking2mouth "...Mm. You're a {color=#0048ff}friend.{/color}"
...
label Nessa2:
    ...
    nessa @talking2mouth "You've got to try harder than {i}that{/i}."
    ...
    nessa @talking2mouth "Believe it or not, I {i}have{/i} refused it. Several times, already."
    ...
    nessa @talking2mouth "That's not why I'm saying no. I'm saying no because you look like you're about double my age."

    roughneck @surprised "What?!"

    nessa @talking2mouth "Think this through. What if I {i}do{/i} go on this date with you? What if we really hit it off, and decide to keep going?"
    nessa @talking2mouth "Then we decide to get married. Have kids. You'll grow old much sooner than I will. Men don't live as long, anyway."
    ...
    nessa @talking2mouth "Then I guess I {i}am{/i} turning you down because you're bald."
    ...
    nessa -surprisedbrow -frownmouth @talking2mouth "Appreciate the timing. And yeah, I'd like that."
    ...
    if (WonBattle("Roughneck4")):
        nessa @talking2mouth "Nicely done, [first_name]. Thanks."

        $ ValueChange("Nessa", 1, 0.66)

        nessa @talking2mouth "Now, please leave me--"

        show nessa surprisedbrow frownmouth with dis

    else:
        nessa frownmouth @closedbrow talking2mouth "...Your Pokémon were more powerful than I thought. I guess I misjudged you."
        nessa @sad "Sorry, [first_name]."
        nessa @talking2mouth "Look, can you please just leave me--"
    ...
    menu:
        ">Run after him":
            ...
            nessa @closedbrow talking2mouth "Don't."
    ...
    nessa @talking2mouth "Yeah. I know."

    pause 1.0

    nessa -sadbrow @talking2mouth "What's that look for?"

    red @sadbrow talkingmouth "Are you alright?"

    nessa @talking2mouth "Of course. That's not the first time I've been called... {i}that.{/i}"
    ...
    nessa @talking2mouth "...Are you doing anything?"

    red @talkingmouth "Hm? Like what?"

    nessa @talking2mouth "Just... anything."

    red @talkingmouth "Well, I was kind of looking for you, actually."

    nessa @talking2mouth "Oh."
    ...
    nessa @talking2mouth "Did he get someone pregnant?"

    red @surprised "What? No."

    nessa @talking2mouth "Did he crash one of his muscle cars?"

    red @confused "No?"

    nessa @talking2mouth "Did Rose kick him out of his Gym?"
    ...
    nessa @talking2mouth "It's 'take the fifth,' and you can't do that, you're Kantonian."

    red @talking2mouth closedbrow sweat "Damn."

    pause 0.5

    nessa -frownmouth @talking2mouth "You're silly. You know that?"
    ...
    nessa @sadbrow talking2mouth "Look, it's ridiculous that I'm even asking this, but... you don't think of me like 'that', do you?"

    red @happy "What? No, of course not! Like I said, the dude was an idiot. You were even turning him down."

    nessa frownmouth @talking2mouth "...Like, you understand the difference between confidence and looseness, right?"
    ...
    nessa @sadbrow talking2mouth "Alright. I've made a decision."

    red @surprised "That was fast."

    nessa @talking2mouth "You tell me about what Rose's problem is with Raihan. And while you're doing that, we'll go shopping."
    ...
    nessa @surprisedbrow talking2mouth "Yeah?"
    ...
    nessa @talking2mouth "Let's walk and talk. {i}Join{/i} is open."
    ...
    nessa @talking2mouth "That boy's ridiculous."
    nessa @talking2mouth "So you're saying that Chairman Rose, of the Galar League, gave Raihan a non-optional paid vacation."
    ...
    nessa @talking2mouth "Well, I'm glad he decided to use his free time to visit Sunny and me."
    nessa @talking2mouth "And I'm glad that he was smart enough to realize he should come to me with this problem. Maybe he's not {i}totally{/i} hopeless."

    red @happy "So you know what Rose's problem is?"

    nessa @talking2mouth "No."

    red @closedbrow talking2mouth "Shoot."

    nessa @talking2mouth "I think I could figure it out, though. Follow me."

    scene insidemall
    show nessa
    with splitfade

    nessa @talking2mouth "I'm interested in hearing {i}your{/i} theory, though. What did {i}you{/i} say?"

    if (HasEvent("Raihan", "DislikeBeatLeon")):
        red @confused "I just said maybe Rose was worried that Raihan will beat Leon, one day."

        nessa @talking2mouth "...I'm sure that gave Raihan an ego boost. Not that he needed one."
        nessa @closedbrow talking2mouth "No, I don't think it's that. Leon's strong. He's {i}ridiculously{/i} strong."
        nessa @sad "I don't think Rose is afraid of anything Raihan can do to him."
        nessa @closedbrow talking2mouth "I think it must be something else."

    elif (HasEvent("Raihan", "DislikePopularity")):
        red @confused "I just said maybe Rose was irritated that Raihan was so popular."

        nessa @talking2mouth "...I could see that. He wants {i}Leon{/i} to be the figurehead of the league, after all."
        nessa @closedbrow talking2mouth "Any attention anyone else gets just takes away from Leon merchandise the league could be selling."
        nessa @closedbrow talking2mouth "Still, I feel like there must be more to it."

    elif (HasEvent("Raihan", "DislikeUnprofessional")):
        red @confused "I just said maybe Rose thinks that Raihan is unprofessional."

        nessa @talking2mouth "...I could see that. For as much ribbing as I give him, Raihan takes his job seriously."
        nessa @closedbrow talking2mouth "But he's not a serious person. At all. Maybe Rose can't see the effort Raihan's making in his Gym."
        ...
        nessa @sadbrow talking2mouth "Some people... get {i}real{/i} jealous."
        nessa @closedbrow talking2mouth "Still, I feel like there must be more to it."

    else:
        red @confused "I had no idea. He didn't either."

        nessa @talking2mouth "I guess we're all in the same boat, then."

    nessa @talking2mouth "Give me a little bit more time to think on this."
    ...
    nessa @talking2mouth "Not sure I could say much. Sonia worked with Macro Cosmos, his company, for a while, when she was helping with her Gran's Dynamax research. Maybe she'd know."
    nessa @closedbrow talking2mouth "All I know is that he's a creepy CEO who would rather die than let Leon have an ounce of attachment to anyone else."
    
    if (IsDate(year = 2004)):
        nessa @sadbrow talking2mouth "I mean, if that ridiculous stunt he pulled during last year's world championship didn't make that obvious, then..."
    else:
        nessa @sadbrow talking2mouth "I mean, if that ridiculous stunt he pulled during two years ago didn't make that obvious, then..."
    ...
    nessa @talking2mouth "You know, the world championships of 2003. Can you believe what he did, then?"
    ...
    nessa @talking2mouth "Oh, wow. So, here's what happened. This is one of the biggest scandals that's ever wracked a Pokémon League--any league--so you should definitely know about it."
    ...
    nessa @talking2mouth "So, the World Championships have been held every four years since 1895, right?"

    nessa @talking2mouth "And there's always a massive bidding war between the regions and cities that want to host it."
    nessa @talking2mouth "Here's the thing. As early as the 1970s, even before I was born, Rose had been trying to get the World Championships to be held in Wyndon."
    nessa @talking2mouth "He constantly campaigned, and petitioned the Galarian league, and even the government, to get the WCs."

    red @confused "Okay. Where's the scandal?"

    nessa @talking2mouth "Getting there. You know rushing me doesn't work."

    red @sweat closedbrow talking2mouth "{i}Do{/i} I."

    nessa @talking2mouth "Well, in 1999, he won, finally. He had to leverage his entire financial empire, and every crumb of influence he had in Galar to make it happen, but he succeeded. The 2003 world championships were going to be held in Wyndon."
    nessa @talking2mouth "Everything went off without a hitch, at least at first. Everyone was there. Diantha, Steven, Alain, Lance. You know, the regulars."

    pause 1.0

    nessa @closedbrow talking2mouth "Of course, the 'big two' were there, as well. Cynthia, 'the strongest woman in the world.' And Leon, 'the undefeatable champion.'"

    red @surprised "Oh, man! I would have {i}loved{/i} to see that battle! Did Leon give you front-row tickets?"

    nessa @talking2mouth "He did. I was so close I could feel the heat coming from his Charizard's tail. I could count the scales on Cynthia's Garchomp, too. Those were {i}amazing{/i} seats."
    ...
    nessa @talking2mouth "Leon's hand was on his Poké Ball. Cynthia was pulling her lipstick out. A really {i}legendary{/i} event was about to happen."
    ...
    nessa @talking2mouth "Oh, that's the stupidest part. He said that he was 'summoning Eternatus' to solve Galar's energy crisis."
    ...
    nessa @talking2mouth "Yeah. It is. And he said he was summoning it."

    pause 0.5

    nessa @talking2mouth "Which is, like, pick a {i}less{/i} obvious lie. Nothing happened. There was no dragon. The energy crisis wasn't solved, and although Rose insisted he {i}had{/i} summoned Eternatus, there was absolutely no evidence of it."
    nessa @angrybrow talking2mouth "Eventually, he just stopped saying he had. I guess he was only saying it for attention, all along."
    nessa @talking2mouth "Maybe that's why he hates Raihan. Raihan gets attention without resorting to pathetic lies."
    nessa @angry "...Tch."
    ...
    nessa @talking2mouth "Not directly. Since all he did was interfere with an event that he was running. The value of Macro Cosmos dropped a few billion, though, as everyone assumed its CEO had gone insane."

    red @confused "To be honest, I think I understand this 'Chairman Rose' even less now than I used to."

    nessa @talking2mouth "He's hard to figure out. Often acts without explaining his actions. Leon's practically his son, with how much time they spend together, and not even Leon knows what he's really thinking."

    pause 1.0

    nessa @talking2mouth "Oh, great. We're here. Wait here, and give me a second."
    ...
    nessa @talking2mouth "Sorry for the wait. How do I look?"
    ...
    menu:
        ...
        "I want to lick you.":
            ...
            nessa @closedbrow talking2mouth "That's disappointing. I'm going to do you a favor and ignore what was obviously an intrusive thought."

        "With your eyes.":
            nessa @closedbrow talking2mouth "You've been spending too much time around Raihan."

    show nessa closedbrow talking2mouth with dis:
        xpos 0.5 xzoom 1
        ease 0.5 xzoom -1
        ease 0.5 xzoom 1
    ...
    menu:
        "You should go back to your old outfit.":
            ...
            nessa @talking2mouth "...You remember what my job is, right?"

            red @talking2mouth "Yeah. Model."

            nessa @talking2mouth "That's right. And I get paid a ridiculous amount of money to listen to people telling me what to wear."
    ...
    nessa @closedbrow talking2mouth "Yes. Pure Wooloo-wool fabric."
    ...
    nessa @talking2mouth "Nothing in particular. Just felt like a change might be nice."
    ...
    nessa @talking2mouth "My normal outfit is the women's uniform of Hulbury Stadium."

    wallace @closedbrow talking2mouth "Ah... Stadiums. That's what Gyms are called in Galar, yes?"

    nessa @talking2mouth "That's right."
    ...
    nessa @talking2mouth "The Gym Leader of Hulbury was my modeling instructor."

    show wallace surprisedbrow frownmouth with dis

    nessa @sadbrow talking2mouth "She wanted me to take over her Gym. She was known as the 'Sapphire of Hulbury'. She was famous for her beauty. Maybe...?"
    ...
    nessa @sadbrow talking2mouth "She did what she wanted, when she wanted, how she wanted. She {i}always{/i} wore her Gym uniform, in case she felt like going for a swim."
    ...
    nessa @talking2mouth "She stopped being able to find modeling jobs. And then... Rose removed her from her position."
    nessa @sadbrow talking2mouth "He didn't {i}say{/i} it was because she now had a face that could scare children, but..."

    pause 1.0

    nessa @talking2mouth "She left the region. I never saw her again."

    narrator "Nessa looks directly at you."

    nessa @talking2mouth "Before she left, she said... to live my most beautiful life at every single second. To never hide anything I could one day lose."

    pause 0.5

    nessa @angrybrow talking2mouth "She was an idealist."
    nessa @sadbrow talking2mouth "She lived in her own world. A world where practicality was a distant third consideration behind beauty and integrity."
    nessa @talking2mouth "She said that beauty was something to be shared with others. As often and as loudly as possibly."
    ...
    nessa @talking2mouth "That could be fun."
    ...
    nessa @sadbrow talking2mouth "I've always lived under those guidelines. I try to think, with every decision I make, how I'll feel when I'm an old woman, closing her eyes for the last time, in front of a dying fireplace..."
    nessa @talking2mouth "I don't want to lose what I have. I don't want to fade away. But I know that I will. So I want to make use of it, now."
    ...
    nessa @sadbrow talking2mouth "I'm sorry. None of this is your problem."

    red @sad "Nessa..."

    nessa @talking2mouth "We should head back to campus. Come on. Let's go."

    $ AddEvent("Nessa", "OutfitSwap")

    scene blank2 with Dissolve(2.0)

    nessa @sadbrow talking2mouth "...Thanks for your patience. I led you on, asking you out right away, didn't I?"
    nessa @talking2mouth "You probably thought you'd be bringing me back to your dorm by now."
    ...
    nessa @sadbrow talking2mouth "You're... a [bluecolor]good friend.{/color}"
