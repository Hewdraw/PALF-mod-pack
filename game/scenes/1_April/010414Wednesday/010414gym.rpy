...
if (not IsNamed("Nessa")):
    ...
    nessa @talking2mouth "Don't think so, no. What's up?"

    red @talkingmouth "I was thinking you looked kinda familiar. Have I seen you somewhere?"

    nessa @closedbrow talking2mouth "Maybe. I've been a model for a few magazines."

    red @talkingmouth "Oh, is that right? I'm [first_name]."

    $ BecomeNamed("Nessa")
    nessa @talking2mouth "Nessa, but I often went under other names. I was a minor until recently, so, you know. Privacy concerns."
    ...
    nessa closedbrow talking2mouth "I think... I'm here because I'm afraid it won't last."
    ...
    nessa -happy @talking2mouth "After the guy talked to my parents, we went back down to the beach and I caught my Drednaw. Back then, I figured that modeling would be something I'd do to fund my Pokémon career..."
    nessa @talking2mouth "And now it's the opposite."
    nessa happy "Heh."
    nessa -happy @talking2mouth "You're a good listener. You're probably only tolerating me 'cause I'm gorgeous, but, hey, thanks anyway."

    red happy "Hey, if I'm going to beat you in battle, I want to know who I'm beating."

    nessa @talking2mouth "Confident, aren't you? That's good."
    ...
    menu:
        ...
        "Could we get to know each other first?":
            ...
            nessa @talking2mouth "That's new. But sure."

            red @talkingmouth "Cool. I'll call you later?"

            nessa @talking2mouth "Okay."

            $ persondex["Nessa"]["Relationship"] = "Classmate"

    $ BecomeContacted("Nessa")

    nessa @talking2mouth "When you have some free time, just call me. I'm free whenever."

else:
    red @happy "Hey, Nessa!"

    if (not HasEvent("Nessa", "DateDeny")):
        nessa @talking2mouth "Hey. Good to see you. Noticed you haven't invited me out on that date yet."
    else:
        nessa @talking2mouth "Hey. Good to see you. Noticed that you haven't invited me to hang out, yet."

    red @sadeyes sadeyebrows happymouth "Uh... would you be offended if I said I've been really busy?"

    nessa @talking2mouth "Nah, I get it. Just keep it in mind."
...
nessa @talking2mouth "I'm not going to be using her in this battle."

red @surprised "Really? Isn't Drednaw a really powerful Pokémon, though?"

nessa @talking2mouth "Yeah. So I need to get the rest of my team to her level."
...
nessa @closedbrow talking2mouth "Yeah, I guess so. Well, I'm not going to tryhard this."
...
nessa @talking2mouth "Hey. You still with us?"
...
if (WonBattle("Nessa1")):
    nessa @talking2mouth "Mm. Good job. You're pretty tough."
...
nessa @talking2mouth "No, battles are fun. I like Pokémon, too. I wanted to be a trainer before I wanted to be a model, remember."
nessa @closedbrow talking2mouth "Hm... how to explain this..."
...
nessa @talking2mouth "Yeah. Everything. The only run that matters is the long-run. So what if I win or lose this battle? It's not even graded."

red @confusedeyebrows talkingmouth "I think... I'm confused."

nessa @talking2mouth "That's fine. It doesn't matter." 
nessa @sadbrow talking2mouth "Try not to take everything so seriously. You'll give yourself wrinkles."
nessa @closedbrow talking2mouth "If you really want to talk more about this... I'm a phone call away."
