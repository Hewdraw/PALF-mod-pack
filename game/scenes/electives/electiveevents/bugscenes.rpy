...
label bug_class_03:
    ...
    bugsy uniform @happy "(Hear that, Poppy? I know you don't love battling--so you can take all the time you need!)"
...
label bug_class_04:
    show burgh with dis
    burgh @norm4 "Let's not beat around the bush. Bug-type Pokémon have their fair share of weaknesses."
    ...
    bugsy uniform @sad "Aw, c'mon! Don't be mean to bugs--they're just little guys!"
    burgh @norm4 "{size=30}(I know, Bugsy. I'm playing devil's advocate.){/size} {i}Ahem{/i}--"
    burgh @norm2  "So what, then, is a Bug master to do? Does anyone have any thoughts?"
    show burgh surprised with dis
    bugsy @happy "Focus on all the things bugs are good at!"
    bugsy @talkingmouth "They're crazy diverse--you've got a big floofy Ice-type, a Pokémon that splits in two when it evolves, a Fire-type bacon centipede..."
    bugsy @angrybrow talkingmouth "Their natural prey are really common, too! You know how many Grass-types are out there? It's a lot!"
    show burgh norm3 with dis
    bugsy @happy "Oh--and they can thrive in literally {i}any{/i} environment. I wouldn't be surprised if there was a space bug out there somewhe--"
    bugsy @talking2mouth "Wait, that's just Orbeetle."
    bugsy @happy "WHICH PROVES MY POINT!"
    burgh @norm2 "Yes, ah... thank you, Bugsy. I couldn't have put it better myself."
    burgh @happy "In addition, Bug Pokémon grow swiftly, in and out of battle. Many can raise their own stats, while lowering those of their opponents."
    burgh norm2 "Don't let their reputation fool you. Underestimating bugs is a mistake few make twice!"
...
label bug_class_05:
    ...
    red uniform @playfuleyebrows talkingmouth "Guess it runs in the family, then."
    bugsy uniform @happy "Um... Yeah! Ahahahaha..."
...
# Player will take first advancement exam here, or possibly earlier if they've done outside studying
label bug_class_06:
    narrator "You pair up with Bugsy for a practice exercise..."
    show bugsy uniform with dis
    red uniform @talkingmouth "Hey, Bugsy. I told you I passed my first advancement exam, didn't I?"
    bugsy @happy "Yeah! I knew you had it in you!"
    red @sadeyebrows talkingmouth "So, if I told you that I was interested in Bug-types, you'd believe me--right?"
    bugsy @talking2mouth "Suuuuure? Is everything okay, [first_name]? You're acting kinda sketchy."
    red @happy "Heh--sorry about that. There's just something I'm really curious about, and I don't want you to take offense."
    bugsy @talkingmouth "Ask me whatever you want! I don't sting."
    red @talkingmouth "Okay. It's kind of a silly question, but: why bugs? What got you hooked on them, instead of some other type?"
    bugsy @happy "That's all? {i}WELL{/i}..."
    bugsy @talkingmouth "{size=20}They're tiny and pretty and cute but really strong, too! Like, did you know Heracross can lift more than a hundred times its body weight? That's six thousand two hundred and fifty kilos! People don't notice them because they're so small and common, but in their own little world every bug is like a superhero. I mean, there {i}are{/i} Bug-themed superheroes on TV, like Ariados-Man, but a real Ariados can do {i}way{/i} crazier stuff!{/size}"
    bugsy @talking2mouth "{size=20}Also, all bugs except maybe those Ultra Beast things--which are still really cool!--form a single phylogenetic group, which means they're all close relatives. You'd think that would make them less diverse than other types, but {i}nope{/i}! Bugs come in a million shapes and sizes, pair off with almost every other type, can burrow or fly or swim or sometimes all of them at once, and they do it all right in our own backyards!{/size}"
    bugsy @talkingmouth "{size=20}{i}Then{/i} there's how beautiful they are. I mean, I'm not really an art person like Burgh is, but I {i}totally{/i} get where he's coming from. Bugs are really inspiring! If you look at them up close, the segments of their exoskeletons are {i}super{/i} intricate, and they all fit together like the pieces of a fancy watch! It'd be, like, impossible to design something that precise--but nature's done it already!{/size}"
    bugsy @happy "{size=20}And bugs are so much fun to spend time with! Like Burgh always says, they're really humble, but they {i}definitely{/i} have strong personalities. Poppy is such a little sweetheart, even though I was kinda nervous around her at first--not a fan of Fire-types; long story--and Fern watches over me kind of like a big brother! It's really funny how protective he gets sometimes. There was this one time when he stared down my ex-boyfriend because he thought that--{/size}"
    bugsy @surprised "(*GAAAAAAAASP*)"
    pause 0.5
    bugsy @talkingmouth "Hah... hah... phew!"
    bugsy @happy "I guess if I had to narrow it down to one thing... they have such little guy energy! They're all trying their best, and I think that's so admirable."
    bugsy @talkingmouth "Does that answer your question?"
    red @happy "And then some! Part of me thought you were gonna say 'well, my parents named me Bugsy, so...'"
    bugsy @sadbrow "..."
    pause 1.0
    bugsy @sad "Yeahhhhh, that's not really how things went."
    bugsy @talking2mouth "I named {i}myself{/i} Bugsy. It's a lot more fun than the name my birth parents came up with."
    bugsy @talkingmouth "And it means more to me because {i}I{/i} chose it, y'know? Not two people I can't even remember."
    red @surprised "...Oh! I didn't realize--I'm sorry for bringing that up!"
    bugsy @happy "Nah, it's cool. I'm happy with my life the way it is! I was adopted by the most caring person I know, and if that hadn't happened I'd be a totally different person!"
    bugsy @talkingmouth "I've heard stories about some peoples' childhoods that make me grateful for my own. I wouldn't undo anything."
    red @sadeyebrows sadeyes talkingmouth "[ellipses]Wow. That's a really great attitude."
    bugsy @happy "Burgh's a really great dad."
    red @embarrassedeyebrows talkingmouth "Oh, shoot--we should probably finish his worksheet, then."
    bugsy @happy "I've got you covered. Wanna check out my notes?"
    narrator "Bugsy proves to be an excellent tutor..."
    hide bugsy with dis
    return
...
label bug_class_08:
    ...
    burgh @happy "Of course, we have a very active recruiter among us, for which I'm quite grateful."
    bugsy uniform @happy "Hehe."
    burgh @norm "But I suspect I also owe thanks to the Battle Team's captain. A former student of mine, you know."
    burgh @norm2 "I hear she's been putting on some memorable performances with her Venomoth's trademark {b}Quiver Dance{/b}."
...
label bug_class_09:
    ...
    red uniform @angrybrow talking2mouth "Ow! Shit."
    bugsy uniform @surprised "You okay, [first_name]?"
    red @angrybrow talking2mouth "Yeah. This little bast--I mean, this {i}adorable little Spinarak{/i}--just bit me."
    bugsy @sad "Oh no! I'm sure she didn't mean it!"
    bugsy @surprised "--Wait. You should take some antivenom for that! Hold on a sec, I'll whip some up for you."
    red @sadeyebrows talkingmouth "Maybe I should just go to the nurse? It's kinda starting to swell..."
    bugsy @talkingmouth "No, trust me--this'll be way faster. And walking to the infirmary is just gonna speed up the renal failure."
    red @surprised "The WHAT?!"
    bugsy @happy "Ssh, ssh--it's gonna be okay! Keep your heart rate down and the poison won't spread so quickly."
    red @surprised mediumblush "My thungue is thtarting to feel funny..."
    bugsy @surprised "Ooh, yeah, and your face is getting all red. That's not so good. But I'm {i}allll{/i}most done."
    pause 1.0
    bugsy @happy "And ta-daa! Here you go! Just drink this."
    pause 1.0
    bugsy @talkingmouth "Any better?"
    red @surprised "Whoa--uh, yeah. Whatever you just made, it's working really quickly."
    bugsy @happy "Great! It's just tea made from Wormadam leaves. Spinarak eat them, so they've got a natural antidote."
    bugsy @sad "Sorry about the scare."
    red @sadeyebrows talkingmouth "All's well that ends well, I guess. But isn't it a little dangerous to keep these Spinarak in a classroom? I mean, it actually {i}attacked{/i} me, and--"
    bugsy @angry "No, she didn't!"
    pause 0.5
    bugsy @sadbrow talking2mouth "...Sorry. I didn't mean to yell."
    bugsy @sad "It's just--people {i}always{/i} assume the worst when it comes to bugs! Every pair of legs makes people think they're creepier!"
    bugsy @happy "She was just doing a little taste test, to see what you were. It's your cologne, I think--it smells {i}just{i} a little bit like Snivy musk."
    redmind @thinking "Oof. They don't put {i}that{/i} on the marketing fliers."
    red @happy "Well, thanks for fixing me up, Bugsy! Have your random picks been sending you to Nursing courses?"
    bugsy @happy "Nope! Gummyworm taught me everything I know. You can't train a Venipede without getting a few stings."
    bugsy @talkingmouth "She's a Whirlipede, now. The name worked better when we were both small and squishy."
    red @playfuleyebrows talkingmouth "I'm just glad you use your powers for good and not evil."
    bugsy @talkingmouth "Yeah! I mean, usually? There {i}was{/i} this one time with a neighbor kid, {i}way{/i} back when."
    bugsy @happy "We got in a fight, so I tricked him into putting Gummyworm's shed skin in his drink."
    bugsy @surprisedbrow talking2mouth "I just wanted to see what would happen, and to see his face when he drank it! I didn't mean to hurt anyone!"
    bugsy @sad "Anyway, poor Burgh had to pay his hospital bill."
    bugsy happy "But don't worry--he lived!"
    narrator "You make a mental note to stay on Bugsy's good side..."
    return
...
label bug_class_10:
    ...
    burgh norm2 "Maybe I'll offer one as a reward... for the most stirring depiction of Ninjask's melody!"
...
label bug_class_12:
    ...
    burgh @surprised "By the way, I've learned Alder's grandson is eyeing the Unovan Championship! Perhaps one day he'll make his way to Kobukan?"
    bugsy uniform @angry "{size=30}Hmph.{/size}"
    red uniform @playfuleyebrows talkingmouth "Rival of yours?"
    bugsy @talking2mouth "He only uses one Bug-type, even though Alder's his grandpa. And even {i}Alder{/i} only uses three."
    bugsy @sad "You know how long it's been since the last all-Bug World Championship team? Like, a hundred years!"
    bugsy @happy "But it's okay. Someday I'm gonna fix that, and show everyone that Bug-types deserve respect!"
    red @happy "You're shooting for the Championship too, huh? Pikachu and I will see you at the top."
    bugsy @happy "Okay, bet! That means eleven Bug-types in the World Championship match!"
    narrator "Bugsy doesn't seem concerned about your other electives..."
    return
...
label bug_class_14:
    show burgh with dis:
        xpos 0.33
    show may uniform angrybrow happymouth with dis:
        xpos 0.66

    burgh @norm2 "Yes, good choice--your [GetTrainerTeam('May', 'Torchic', heal=False).GetNickname()] is an excellent counter for Swadloon. Come, now: show me what you've learned!" 
    $ PlaySound("pokemon/cries/255.mp3")
    show burghbg with dis
    hide burgh with dis
    hide may with dis
    ...
    red @happy "Oh, the flash? That was just May's Torchic! She's taking her advancement exam."
    bugsy @sadbrow talkingmouth "Oh--oh, geez. {i}That's{/i} good."
    pause 2.0
    red @confused "Hey, Bugsy?"
    bugsy @talkingmouth "What's up?"
    ...
    red @confused "Pokémon never glare at me like that. Not unless--"
    bugsy @surprised "I'm sorry!"
    bugsy @sadbrow talking2mouth "You're right... that was, uh, definitely a glare. He probably thought you set off those sparks."
    bugsy @sadbrow talkingmouth "Fern's kinda like my big brother. He gets really protective when he thinks I'm in trouble."
    bugsy @sadbrow talking2mouth "Especially after the whole 'almost dying in a fire' thing."
    pause 1.0
    red @surprised "Holy shit, what?! Is that how you ended up--I mean, how your parents--I'm so sorry!"
    bugsy @happy "No, this was {i}way{/i} after."
    bugsy @sadbrow talkingmouth "I guess I should just tell you the whole story, huh?"
    bugsy @talking2mouth "I grew up in a group home. I don't really know anything about my birth parents--not even their names. Not even if they're alive."
    bugsy @happy "But who knows? Maybe they had to give me up for some really good reason. I {i}could{/i} be the secret lost heir to Unovan royalty."
    red @playfuleyebrows talkingmouth "Hey, anything's possible."
    bugsy @sadbrow talkingmouth "Anyway, people at the group home were mostly nice! My childhood wasn't very exciting or anything."
    bugsy @talkingmouth "Not until I met Fern. He was still a Scyther back then--and somehow, he'd wandered into Nacrene City."
    bugsy @sad "He was young, and hurt. I helped him calm down, so he'd let the nurses near him--instead of, y'know, getting slashy."
    red @surprisedeyebrows talking2mouth "It takes a lot of guts to calm down a pissed-off Scyther. How old were you?"
    bugsy @happy "Ummmm... I {i}think{/i} twelve?"
    red @talkingmouth "No wonder Fern feels like he needs to watch your back!"
    bugsy @sadbrow talkingmouth "He's always been great at that. When the group home burned down, he's the one who got me out in one piece."
    red @sad "..."
    bugsy @happy "Anyway, I almost died, so {i}that{/i} was pretty terrifying. But Fern saved me, and we've been together ever since. The end!"
    red @confusedeyebrows talking2mouth "Wait, it is? How does Burgh come into the picture?"
    bugsy @talkingmouth "{i}Welllll{/i}... After the fire, Fern took me into Pinwheel Forest. And we got super, {i}super{/i} lost."
    bugsy @sadbrow talkingmouth "That night it seemed really dark and scary. But when I opened my eyes in the morning, everything I saw was bright and beautiful."
    bugsy @talkingmouth "Fern was right there with me, and even though I was still scared, I felt safe."
    bugsy @talking2mouth "We lived in Pinwheel Forest for about a month. If Fern hadn't helped catching food, I probably would've died."
    bugsy @talkingmouth "Buuuuut, eventually we found our way out! That's when we met Burgh. I didn't have anywhere to go back to--no group home, no parents--so Burgh took me in himself." 
    bugsy @happy "He's a big softie like that."
    bugsy @happymouth "Anyway, there you have it! That's my tragic orphan backstory. Except it's not really tragic, because everything turned out fine!"
    bugsy @talkingmouth "Everyone made it out of the fire, Fern and I got to stay with my dad, and now we're here at Kobukan together!"
    red @sad "...Wow."
    bugsy @surprised "What's wrong? Why do you look so sad?"
    pause 0.5
    red @sadeyebrows sadeyes talkingmouth "You know what? It's nothing. If you don't think that's a sad story, I won't make it into one."
    red @sadeyebrows sadeyes talkingmouth "I'm just kind of amazed. Most people would be a wreck after everything you've gone through. But you're, like, the least screwed-up person I've met at Kobukan."
    bugsy @talking2mouth "Eh. I don't think I'm that special. The past is the past, so what's the point of worrying about it? Let Flygons be Flygons."
    red @talkingmouth "That was a terrible pun."
    bugsy @happy "Then you won't bee-lieve what I've got in store."
    red @closedeyes talkingmouth "{i}Ugh.{/i}"
    narrator "Bugsy's sense of humor reminds you of Nate's..." # I checked, and it's impossible to get this event without already knowing Nate.
    return
...
label bug_class_15:
    ...
    burgh happy "But it comforts me to think of my great-great-grandchildren, playing in the mud with their Sewaddle."
    narrator "Burgh shows some cut-paper artwork made by his first Sewaddle, while Bugsy holds a Poké Ball tightly..."
    return

# This is the typical point where a player would take the second advancement exam.
...
label bug_class_18:
    ...
    burgh @norm2 "Bugsy, if you would?"
    show burgh with dis:
        xpos 0.5
        ease 0.5 xpos 0.33
    show bugsy uniform with dis:
        xpos 2.0
        ease 0.5 xpos 0.66
    bugsy @happy "A-{i}hem{/i}!"
    bugsy @talkingmouth "{size=30}The word 'bug' actually refers to the Hemiptera, an order of insects! They're the ones with little sucking mouthparts that they stick into plants to drink sap! Surskit is a bug, but {i}actually{/i}...{/size}"
    bugsy @surprised "{size=30}...most Bug Pokémon aren't true bugs at all! Usually when people say 'bug' what they {i}really{/i} mean is 'insect', and those are the little guys with six legs, one or two pairs of wings, and an exoskeleton.{/size}"
    bugsy @talkingmouth "{size=30}BUT! There are other kinds of Pokémon with exoskeletons, too, like arachnids and crustaceans and trilobites! They've got different numbers of legs and different patterns of body segmentation. Arachnids, like Spinarak, always have eight.{/size}"
    bugsy @happy "{size=30}They're even {i}further{/i} from actual bugs. So within the Bug {i}type{/i}, you've got bugs, and 'bugs', and ~BuGs~, and they're all different. But they're also all cute, tiny little babies who deserve your love!{/size}"
    bugsy @talkingmouth "Bugsy, out."
    show burgh with dis:
        xpos 0.33
        ease 0.5 xpos 0.5
    show bugsy uniform with dis:
        ...
        ease 0.5 xpos 1.5
    hide bugsy with dis
    burgh @norm2 "Thank you, Bugsy."
    burgh @happy "Classification aside, Tarountula is still a Bug-type at heart. And while it never weaves a cocoon, it does something quite similar."
    ...
    narrator "Bugsy makes for a natural teaching assistant..."
    return
...
label bug_class_21:
    ...
    bugsy uniform @happy "(Heh. Cuuuuute!)"
    ...
    bugsy uniform @happy "(And makes it easier to hold hands.)"
    burgh @norm2 "Through each expression the cast paints life upon the stage, with your own imagination as their brush."
...
label bug_class_22:
    show hall_A with splitfade
    narrator "You're on the way to your next elective when..."
    Character("???") "\"{size=40}KYAAAAAAAAAAAAAHHHHHHH!!!{/size}\""
    red uniform @surprised "Oh, shit! That sounded like Misty!"
    red @angrybrow talking2mouth "Hold on! I'm coming!"
    show misty uniform surprised with dis:
        xpos -1.0 xzoom -1
        ease 0.5 xpos 0.33
    misty closedbrow angrymouth "Gross, gross, GROSS! {i}UGH!{/i}"
    red @surprised "Misty, are you okay?! What's going on?"
    misty surprised "G-GAH! You {i}have{/i} to stop scaring people like that!"
    misty closedbrow poutsadmouth "A-anyway, I'm FINE. I just found a stupid, ugly, hairy little bug crawling in my sock draw--"
    show misty uniform surprised with dis:
        xpos 0.33 xzoom -1
    show bugsy uniform with dis:
        xpos 1.5
        ease 0.5 xpos 0.66
    bugsy @talkingmouth "Did somebody say 'bug'?"
    show bugsy with dis:
        xpos 0.66
        ease 4.0 xpos -1.0
    misty @closedbrow angrymouth "Okay, first of all, it's not JUST a bug--this one is even creepier and hairier than usual!"
    misty @closedbrow angrymouth "It's got nasty little fangs, and WAY too many legs, and it's probably super poisonous, so I'm lucky I got out ali--"
    bugsy "Oh, it's a tiny Joltik! Hey there, lil' guy!"
    bugsy "Yoink."
    ...
    show bugsy uniform with dis:
        xpos -1.0
        ease 0.75 xpos 0.33
    bugsy @happy "Heck yeah--I've always wanted a Galvantula! I think I'll call him 'Socks'."
    misty @surprised "You... you {i}want{/i} that thing? What are you, the Bug Whisperer?"
    bugsy @sad "Well... I guess you can have him if you {i}want{/i}. It's 'finders keepers', after all."
    misty @happy "NO! I mean, no, I, hahahah..."
    misty @closedbrow talkingmouth "I'll let you keep it out of the goodness of my heart. Since you want it {i}soooo{/i} badly."
    bugsy @happy "Sweet! You're the best, random stranger!"
    misty @talking2mouth "It's Misty."
    bugsy @talkingmouth "Nice to meet you, Misty! I'm Bugsy! You wanna know something really neat about Joltik? When it rains out they--"
    show bugsy uniform surprised with dis:
        xpos 0.33
    red @sadeyebrows talkingmouth "Hey, Bugsy? We should probably get a move on or we'll be late for class."
    bugsy @surprised "Oh, shoot--you're right! Gotta go I'll see you there bye!"
    hide bugsy with dis
    misty @angrymouth "[ellipses]You saw nothing."
    hide misty with dis
    scene classroom
    show bugtype:
        xalign 0.5 yalign 1.0
    with splitfadefast
    narrator "Class, at least, passes uneventfully..."
    return
...
label bug_class_25:
    ...
    bugsy uniform @happy "WHAT?! Why didn't you tell me earlier??"
    burgh @norm2 "Ah--apologies for that, Bugsy. I didn't want to spoil the surprise!"
    burgh @norm2 "In any case, this is a tremendous honor. I've done plenty of shows before, but Nimbasa's art scene is *very* posh. My style has always been too 'rustic' for their tastes."
    ...
    bugsy uniform @talkingmouth "Hey, everyone! Three cheers for Burgh, the hardest-working guy I know, who totally, one-hundred-percent deserves this!"
    burgh @norm2 "Bugsy, I'm certain that's not necessary--"
    show burgh surprised with dis
    bugsy @happy "C'mon, you guys can do better than that! THREE CHEERS FOR BURGH!!!"
...
label bug_class_27:
    ...
    bugsy uniform @happy "It was totally inspired! Just, ummmm... not very popular!"
    burgh @norm2 "That's a rather generous way to put it."
    burgh @happy "Regardless, you ought to visit again! Castelia Gym has always been one of my favorite canvases."
...
label bug_class_29:
    ...
    burgh @happy "As it happens, we've a Scizor trainer among us. I'll allow them to take the floor."
    show burgh with dis:
        xpos 0.5
        ease 0.5 xpos -1
    hide burgh with dis
    pause 1.0
    show bugsy uniform with dis
    bugsy @happy "And the mysterious Scizor trainer is... me! SURPRISE!! {size=20}(Except probably not.){/size}"
    show bugsy uniform with dis:
        xpos 0.5
        ease 0.5 xpos 0.2
    $ scizornum = 212
    $ sidemonnum = scizornum
    $ PlaySound("Pokemon/ball sound.ogg")
    $ PlaySound("pokemon/cries/212.mp3")
    show sideportraitfull at pokeball, dormdesk
    bugsy @talkingmouth "Say hi to Fern, everone! He's been my partner since we were kids!"
    $ PlaySound("pokemon/cries/212.mp3")
    rosa uniform @talkingmouth "Burgh let you have a Scizor? That's so cool!"
    may uniform @surprised "But... aren't they supposed to be kind of dangerous for kids?"
    skyla uniform @surprised "Ooh--I've got a question, too! How did yours evolve so fast?"
    bugsy @happy "Because I'm a genius, obviously!"
    bugsy @talkingmouth "Hehe--nah, it's not that. Scyther evolves by trading--you just have to give one a Metal Coat and swap it with somebody else."
    ...
    bugsy @happy "His Bug Bite and Bullet Punch hit {i}way{/i} harder than usual--they do a whole 50%% more damage."
    bugsy @surprised "Burgh tells me Scyther used to have a second, entirely-different evolution. It was a Bug/Rock type called Kleavor, but it went extinct back in the Hisui period."
...
label bug_class_30:
    ...
    burgh @happy2 "How are things going with your boyfriend? Have you heard about all the drama at Kobukan? My students this year are {i}exceptional{/i}--Bugsy, of course, but there's also--"
...
label bug_class_31:
    show burgh with dis
    burgh @norm4 "A little to the left--yes, that one, if you please. Bugsy, would you take it from Charlotte and add it to the 'mixed media' pile?"
    bugsy uniform @sad "Gotcha. Just... let me know if you need anything else, okay? Anything at all."
    burgh @sad "{i}*Sigh*{/i}... Thank you, dear."
    pause 1.0
    burgh @surprised "Ah! Hello, everyone--please don't mind the {b}Ariados{/b}. They're helping me take down my work from the classroom walls."
    ...
    burgh @sad "I've had to change it, rather last-minute. It's a long story, but I'll make it brief."
...
label bug_class_32:
    ...
    burgh @norm2 "Well, you've heard it from my esteemed colleague. With Valerie handling things--and with Bugsy by her side--I'm sure you'll hardly miss me."
...
label bug_class_34:
    ...
    bugsy uniform @happy "{size=30}Heh. 'Mud.'{/size}"
    red uniform @surprised "What?"
    bugsy @talkingmouth "It's the kind of 'mud' you step on in a Tauros pasture."
    red @unamusedbrow talking2mouth "Eww."
    valerie "Most wouldn't perceive Rellor's mud-balls as beautiful--let alone as works of art. But Rellor are patient, and build their masterpieces through every sort of tribulation."
...
label bug_class_36:
    ...
    burgh sad "{size=30}If we must.{/size}"
...
label bug_class_39:
    show burgh with dis
    narrator "You find Burgh and Bugsy furiously scrubbing spray paint from the classroom wall..."
...
label bug_class_40:
    show burgh sad with dis
    red uniform @talking2mouth "Come on, Burgh. You can't tell me {i}that{/i} was because of some bad reviews."
    ...
    burgh "...You."
    burgh @angry2 "Anthea told me you'd bought your way into parole, then bought {i}my{/i} way into this gallery."
    ...
    burgh @angry2 "If you wanted to speak privately, you wouldn't have cornered me in public! Did you think I'd hold my tongue? That you could pressure me into saying that all is forgiven?"
...
label bug_class_x4:
    ...
    burgh @norm2 "The family I've found--Bugsy; my partner; my Pokémon; my students--has brought me more joy than I can possibly express."
...
label bug_class_x5:
    ...
    show bugsy uniform with dis
    bugsy @happy "Hey, [first_name]! You came back!"
    red uniform @talkingmouth "How could I resist? You gave a heck of a sales pitch."
    bugsy @happy "Yessss! I knew it!"
    red @sadeyebrows talkingmouth "Just for the record, people don't usually quit after the first class, do they?"
    bugsy @surprised "Oh, no! Definitely not!"
    pause 0.5
    bugsy @sad "...Only sometimes."
    bugsy @talking2mouth "I dunno. Some people come here because they think it'll be an easy class. Then they bail once they realize they have to take it seriously."
    bugsy @happy "But not you! You're one of us now. We can be Bug buddies!"
    red @surprisedeyebrows "[ellipses]"
    red @happy "You know what, I like it! Bug buddies it is!"
    bugsy @happy "High-five! {w=0.5}{nw}" 
    $ PlaySound("clap.ogg")
    extend @happy "That's the right attitude! Burgh's gonna love you--I can already tell."
    redmind @thinking "Just 'Burgh' again, huh? Part of me wants to ask, but..."
    pause 0.5
    red @talkingmouth "So, what other classes are you taking, Bugsy?"
    if (IsAfter(30, 5, 2004)):
        red @surprisedbrow talking2mouth "I don't think I've seen you anywhere else."
    bugsy @happy "All of them."
    pause 0.5
    red @surprised "{i}All{/i} of them? Jeez, I thought my schedule was ambitious!"
    bugsy @sad "Well, I guess it's more like 'none of them'? Depends how you look at it."
    bugsy @talkingmouth "I come to Burgh's class every day, and after that I just pick a random number. Life is funnier when you go in blind."
    red @surprised "Wait, so--you're only studying one type? What about the starter you were assigned?"
    bugsy @talkingmouth "Larvesta."
    red @unamusedeyebrows talking2mouth "So you don't care what your other elective is, at all."
    bugsy @happy "Nope! They're all good for something. There's Electric for Galvantula, Steel for Scizor, Poison for Dustox..."
    red @talkingmouth "How about Dragon?"
    bugsy @talkingmouth "That's easy--Flygon."
    red @talkingmouth "Normal?"
    bugsy @happy "Eevee!"
    red @angryeyebrows talkingmouth "Eevee doesn't have a Bug-type evolution."
    bugsy @happy "Yet."
    red @sadeyebrows "[ellipses]"
    red @sadeyebrows talkingmouth "You know, I don't think I've ever met someone so committed to their type. It's... kind of refreshing."
    red @talkingmouth "Before I came here, the one thing I was sure about was that I wanted to train my Pikachu. I didn't pick my classes {i}randomly{/i}, but I really had to think about it."
    red @happy "But it seems like you've got everything figured out! You know exactly what you love, and you're all-in. I think that's pretty great."
    bugsy @happy "Hey, you never know! Maybe you'll love bugs just as much, and you don't even know it yet."
    bugsy @talkingmouth "We're kind of a cult, but we're the {i}nicest{/i} cult, promise."
    red @talkingmouth "Well, I guess you're in charge of my initiation, Grandmaster Bugsy."
    bugsy @happy "Aw, c'mon--I'm not in charge of anything! We're in this together, Bug buddy!"
    hide bugsy with dis
    return

label bug_class_x6:
    scene academyhall with splitfade
    show bugsy uniform sad with dis
    red uniform @talking2mouth "Hey, Bugsy--wait up a sec."
    bugsy @sad "Oh! Hey, [first_name]. What's up?"
    red @sadeyebrows talkingmouth "That's what I was about to ask you. Is your dad okay?"
    red @talking2mouth "It doesn't like the exhibition went the way he'd hoped."
    bugsy @angry "Oh, the {i}exhibition{/i} went fine. The only problem is his stupid jerk of a--"
    bugsy @angry "[ellipses]"
    bugsy @sad "{i}Ugh.{/i}"
    bugsy @sad "Look... Thanks for asking, seriously. I promise I'm not trying to keep secrets or anything--I trust you."
    bugsy @talking2mouth "But this is probably something you should ask Burgh himself. His story to tell, y'know?"
    red @sadeyebrows sadeyes talkingmouth "Gotcha. That's totally fair."
    red @talkingmouth "Do you think it would be okay if I caught up with him after next class? I don't want to bring up bad memories or something, but--"
    bugsy @happy "No, no! Actually, I bet he'd really appreciate that."
    red @happy "Thanks, Bugsy. You're the Bug Whisperer {i}and{/i} the Burgh Whisperer."
    bugsy @happy "I sure hope so! He's always taking care of everyone else--so I've gotta have {i}his{/i} back, too."
    hide bugsy with dis
    return