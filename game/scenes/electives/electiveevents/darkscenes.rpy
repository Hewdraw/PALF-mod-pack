...
label dark_class_03:
    ...
    karen @happymouth "That's the price of the gambit. Predict correctly, and you land one of the strongest priority attacks there is. Misread your opponent and you whiff."
...
label dark_class_36:
    ...
    if (GetRelationshipRank("Hilbert") >= 2):
        narrator "After class, you run into a familiar face..."
        show shauntal with dis
        shauntal @talkingmouth "Um... Excuse me!"
        red uniform surprised "Huh? Are you talking to me?"
        shauntal @happy "Yes--to the boy around whom the crowd parts, his red hat a mark of defiance!"
        red @happy "Um... That's me, I guess! I'm not sure my hat is a 'mark' of anything, though."
        red @talkingmouth confusedeyebrows "Wait a minute. I know you! You work at Gray Library in Inspira. Shauntal, right?"
        shauntal @surprised "Oh--yes! You came by with your friend, to research military technology!"
        red @surprised "Wow--I'm surprised you remember us! Doesn't the library get a ton of visitors?"
        shauntal @sad "Most of them don't stay long. I keep telling the Director to turn up the thermostat..."
        shauntal @angry "And... and it was {i}you{/i} who found what that vandal had done to L'Éncyclopedie de Kalos! Did you ever bring him to justice?!"
        red @sadbrow talkingmouth "I think we're trusting in the moral arc of the universe for that one."
        red @talkingmouth "Anyway, it's nice to see you again. Were you looking for something?"
        shauntal @surprised "Oh, yes! This is Karen's classroom, right? Do you know whether she's around?"
        red @talkingmouth "Sorry, you just missed her--she left a few minutes early. There was a faculty meeting, or something."
        red @surprised "Wait, just 'Karen'? Do you know her?"
        shauntal @happy "Hee hee! I certainly do--we met in this very classroom!"
        shauntal @talkingmouth "In any case, could you tell her I stopped by? It's nothing urgent, don't worry."
        red @talkingmouth "Sure, I'll let her know. And thanks again for your help at the library."
        shauntal @happy "Always a pleasure!"
        ...
        shauntal @happy "Yes--to the boy around whom the crowd parts, his red hat a mark of defiance!"
        red happy "Um... That's me, I guess! I'm not sure my hat is a 'mark' of anything, though."
        shauntal @surprised "Oh-! I'm sorry! Sometimes I get carried away."
        shauntal @talkingmouth "It's just--has anyone ever told you that your bearing screams 'protagonist?'"
        ...
        shauntal @happy "Hee hee! No, I'm not--we used to be classmates, though."
        $ BecomeNamed("Shauntal")
        shauntal @talkingmouth "My name is {b}Shauntal{/b}--could you tell her I stopped by? It's nothing urgent, don't worry!"
        red @talkingmouth "Sure, I'll let her know. It's nice to meet you, Shauntal--I'm [first_name] [last_name]."
        shauntal @happy "A pleasure to meet you as well, [first_name]! I'm sure we'll meet again!"
        hide shauntal with dis
        redmind @thonk "Huh... Maybe she's on the staff."
...
label dark_class_x3:
    ...
    karen @talking2mouth "And we're working round-the-clock to make sure everyone comes home safe. You can count on it."
