...
label fairy_class_07:
    ...
    valerie @happy "I know! Why don't we ask for some help from Burgh's Galvantula? Both of them have such wonderful taste."
...
label fairy_class_31:
    ...
    valerie @sadbrow poutmouth "Unfortunately, that {i}does{/i} change its Disarming Voice from Fairy-type."
