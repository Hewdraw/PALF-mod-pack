...
label fighting_class_20:
    ...
    marshal angry2 "{i}Tsuki ni kawatte... OSHIOKI YO!!{/i}"
...
label fighting_class_40:
    ...
    hide alder with dis # There probably shouldn't be a proficiency gain here, or other students showing up smiling
    return
