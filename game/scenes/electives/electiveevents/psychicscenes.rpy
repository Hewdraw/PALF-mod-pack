...
label psychic_class_02:
    ...
    red uniform @talking2mouth "Hey, Morty--is that true?"
    morty @surprisedbrow "Hm?"
    red @sadbrow talking2mouth "What Instructor Will said, I mean. About ghosts being horrified by their own existence."
    morty @happy "I wouldn't read too much into it. Some of them have grudges, sure, and it's not like they {i}love{/i} being dead. If they were even alive in the first place."
    morty @sadbrow talkingmouth "But most of them just seem kind of... bored."
    red @surprised "Huh."
    morty @talking2mouth "Everything matters less when you've already checked out. It's not like politics or the weather make much of a difference to them."
    morty @talkingmouth "Mostly they stick around because boredom is comforting. Moving on seems scarier."
    morty @closedeyes talkingmouth "That's my guess, at least."
    red @sadbrow talkingmouth "I don't know if hearing that makes me feel better or worse."
    morty @talkingmouth "Like I said: don't overthink it. You don't seem like the lingering type."
    hide morty with dis
    redmind @thinking "Okay, I {i}really{/i} don't know how {i}that{/i} makes me feel."
    scene classroom
    show psychtype
    with splitfade
    return
...
label psychic_class_04:
    ...
    morty uniform @closedeyes "Zzzz..."
    redmind uniform thinking "Should I poke him?"
...
label psychic_class_07:
    ...
    morty uniform @sleepyeyebrows sleepyeyes talking2mouth "So what's the downside?"
    will @surprised "Downside? Who says there {i}is{/i} a downside? Perhaps Dream Eater is a move so strong that..."
...
label psychic_class_08:
    ...
    morty uniform @talking2mouth "Hey, Instructor? Traffick in hearsay a little bit."
    redmind thinking "Huh... I've never seen Morty so interested."
    will @surprised "Ah, well--if you insist!"
    will @talking2mouth "There's a common tale among old Hoennian mariners about a Pokémon called {b}Phione{/b}."
...
label psychic_class_11:
    ...
    will @happy "They {i}can{/i} blink, by the way. They just choose not to..."
    narrator "Will sends you off with a new assignment..."
    hide will with dis
    scene academyhall with splitfade
    show morty uniform with dis
    red uniform @surprised "So he wants us to, what, pair off and try reading each other's minds?"
    morty @sleepyeyebrows sleepyeyes talkingmouth "I mean, feel free. You can read aaaaaaall my dark secrets, like how I feed my Misdreavus cheese whip."
    morty @talkingmouth "The way I've got it figured, I'm the one with the easy job."
    if (IsBefore(1, 5, 2004)):
        morty @talkingmouth "I mean, you seem like a pretty open book. All I've gotta do is write down how bad you wanna be Champion."
        red @happy "Heh. I guess that's true."
        red @talkingmouth "I thought you meant you had the easy job because you're an Esper."
        morty @talking2mouth "Told you before: I'm not {i}that{/i} kind of Esper. I do ghosts, and that's it. Can't read minds or levitate a dust bunny."
        red @talkingmouth "Hey, can I ask you something? If you're 'not that kind of Esper', and you mostly train Ghost-types, why are you taking this class?"
        morty @surprised "It's like I said--Instructor Will pretty much dragged me in here. Guess I'm kind of a letdown."
        red @surprised "That's the only reason?"
        morty @embarrassedeyebrows embarrassedeyes talking2mouth "Well... not exactly."
    else:
        morty @talkingmouth "That's how your Frienergy works, right? You can't read my mind, but I'm supposed to understand {i}you{/i} easier."
        red @surprisedbrow talking2mouth "Yeah, that's... exactly how it works."
        red @sadbrow talking2mouth "Usually it takes more explaining."
        morty @closedeyes talkingmouth "It's not so complicated. There are legends about Espers who made that kind of thing seem tame."
        red @surprised "Oh, that's right! You're interested in mythology, aren't you?"
        morty @surprised "How d'you figure?"
        red @talkingmouth "The other day, when Instructor Will was talking about Phione--you were really into it."
        red @happy "Usually, when he's rambling on like that, you look ready to pass out."
        morty @embarrassedeyebrows embarrassedeyes talking2mouth "Guess you got me there."
    morty @talking2mouth "I grew up in Ecruteak. Ever been?"
    red @sadbrow talkingmouth "Nope, sorry. My school never held a class trip--the fancier one in Viridian did, though."
    morty @talkingmouth "Well, it's real old. Half the buildings are sacred, the other half are haunted, and we've got more shrine maidens than cops."
    morty @embarrassedeyebrows embarrassedeyes talkingmouth "Growing up in a place like that makes history come alive, y'know?"
    morty @closedbrow talking2mouth "Especially when you can {i}talk{/i} to history. First ghost I ever met was from the Heian period."
    morty @embarrassedeyebrows embarrassedeyes talkingmouth "Myths; legends; stories about psychic powers... I kinda eat that stuff up."
    red @happy "Hey, that's pretty cool! I kind of thought you were, I dunno, a slacker. But it turns out you're a real nerd!"
    morty @talkingmouth "Keep it under wraps, or you'll go raising the prof's expectations. Can't have that."
    scene classroom
    show psychtype
    with splitfade
    return
...
label psychic_class_12:
    ...
    will @talkingmouth "There is also a secret technique called {b}Miracle Eye{/b}, which makes Dark-types vulnerable to Espers. Xatu is among the few Pokémon which learns it."
    will happy "I {i}suppose{/i} you could opt for a Metagross or Alakazam. But neither of them can perch on your shoulder."
...
label psychic_class_14:
    show will with dis
    will @talkingmouth "Well! I'm glad to see our little mailbox is already getting some use."
    will @sadbrow talkingmouth "But, ah... perhaps it might be saved for more serious requests?"
    will @talking2mouth "I suppose I can't {i}disprove{/i} that one among us is the reincarnated daughter of 'His Distorted Eminence, the Dark Lord Giratina'..."
    hexmaniac uniform @happy "(Ufufufufufufu...)"
    will @talking2mouth "...and that this 'Umbra-Maiden' requires a sacrifice to restore her 'Cursed Hand of the Devouring Void'..."
    will sadbrow @talking2mouth "But I do find this prohibitively unlikely."
    hexmaniac @sad "...!"
    will @talkingmouth  "There's nothing wrong with entertaining a bit of fantasy, or with a desire to discover oneself 'special'."
    will @talking2mouth "But let's remember, please, that many Espers would relinquish their powers were they able."
    will angrybrow frownmouth @talking2mouth "And that hoary stereotypes, painting Espers as warlocks, do not generally help our cause."
    narrator "Will hopes a certain student will outgrow her delusions..."
    return
...
label psychic_class_16:
    ...
    scene academyhall with splitfade
    show morty uniform with dis
    red uniform @talkingmouth "Hey, Morty--doesn't Ecruteak have a dance theater full of Eevee trainers?"
    morty @sleepyeyebrows sleepyeyes talking2mouth "Yup. Those'd be the Kimono Girls. Used to be a sacred priesthood, but now they're more of a tourist attraction."
    red @talkingmouth "I smell a legend coming on."
    morty @talkingmouth "Twist my leg, why don't you."
    morty @talking2mouth "So, back in the fifteen-hundreds, there was a samurai who teamed up with every Eeveelution. Supposedly, I mean."
    red @surprised "His team had eight Pokémon? I thought six was the max."
    morty @happy "Only seven. And c'mon; you think they had party-limit laws back then? Those didn't exist until 1804."
    morty @talkingmouth "Nobody {i}needed{/i} them, for one thing. Even the best trainers had two, maybe three Pokémon. That's what made this hero so special."
    morty @talking2mouth "Anyway--long story short--hero gets killed by the warlord Nobunaga. His wife's a crazy-powerful Esper; she dies too."
    morty @closedeyes talking2mouth "And their spirits haunt Ecruteak, causing this big plague, until a temple gets built to placate them."
    morty @talkingmouth "That'd be the Ecruteak Dance Theater. The Kimono Girls, with their Eeveelutions, dance to keep the dead at peace."
    morty @happy "Seems like that job's long done, though. My folks used to drag me there for 'culture', and I never saw any samurai ghosts."
    red @sad "Are all ancient legends that depressing?"
    morty @talkingmouth "Not all of 'em. Just most."
    scene classroom
    show psychtype
    with splitfade
    return
...
label psychic_class_17:
    ...
    red uniform @talkingmouth "Is that how things went for you, Morty? You said there are other mediums in your family."
    morty uniform @sleepyeyebrows sleepyeyes talking2mouth "{i}*Yaaaaawn*{/i}... Yup, pretty much. We get one every couple of generations--last one was my grandma."
    red @talkingmouth "So I guess you weren't scared of ghosts growing up."
    morty @closedeyes talkingmouth "Nah. I was more scared of Ledyba. Dunno why, but those things give me the creeps."
...
label psychic_class_19:
    show will with dis:
        xpos 0.33
    show hexmaniac uniform with dis:
        xpos 0.66
    will @happy "You wish me to read your fate? But of course! Such is child's play for the Great Will! Behold, and I shall--"
    hexmaniac @happy "Yes? Yes??"
    pause 0.5
    will sadbrow @surprised "Oh. Oh, dear."
    hexmaniac surprised "W-what's wrong? Art thou overwhelmed by the grand portents of my destiny??"
    will @sad "..."
    will @sad "You're quite serious, aren't you."
    show hexmaniac uniform sad with dis:
        xpos 0.66
    ...
    show will with dis:
        xpos 0.33
        ease 0.3 xpos 0.5
    will @sad "In truth, my dear... there is no such thing as {i}perfect{/i} foresight."
    ...
    will @sadbrow talking2mouth "But I can't foresee whether your life will be a happy one, or whether your destiny is... er... 'portentious'. No psychic can, and I wouldn't tell you if I could."
    ...
    morty uniform @closedeyes talking2mouth "{size=30}Pathetic.{/size}"
    red uniform @surprised "Huh?"
    pause 1.0
    morty @closedeyes "..."
    pause 1.0
    morty @closedeyes "Zzzzz..."
    pause 1.0
...
label psychic_class_22:
    ...
    red uniform @unamusedeyebrows talking2mouth "Jeez. You think anybody ever manages this?"
    morty uniform @sleepyeyes talking2mouth "The drowned student right behind you says 'nope.'"
    red @surprised "G-gah!!"
    morty @closedeyes talkingmouth "Gotcha."
...
label psychic_class_23:
    ...
    will @talking2mouth "Be aware of these thoughts. Observe them, as if they were clouds in the sky."
...
label psychic_class_24:
    ...
    will @surprised "This means that staples like Psychic and Psyshock are rarely added to their movesets. Some trainers don't equip Metagross with Psychic-type moves at all!"
...
label psychic_class_26:
    ...
    show morty uniform with dis
    morty sad "...You good?"
    red uniform @surprised "Sure--what do you mean?"
    pause 0.5
    morty @closedeyes talking2mouth "...Nothing, I guess."
    morty @talking2mouth "Just figured you might've found that speech a little rich."
    hide morty with dis
    red @sad "..."
    scene classroom
    show psychtype
...
label psychic_class_29:
    ...
    will @surprised "Is that a Twisted Spoon I see?! Are you certain you bent it using only your mind?"
    show hexmaniac uniform with dis:
        xpos 0.66
    hexmaniac @surprised "I... I did?"
    hexmaniac @talkingmouth "He... hehe..."
    pause 1.0
    hexmaniac @happy "AHAHAHAHAHAHA!!"
    hexmaniac @happybrow talkingmouth "Of course I did!!! All is as I told you from the start--the great Lord Giratina speaks through this mortal shell!!!"
    hexmaniac @talkingmouth "Behold!! Thou hath witnessed His Deathless Excellency's fifth-circle invocation: 'Raiment of the Apocalypse: Black Moon of Rent Steel'!!!"
    pause 1.5
...
label psychic_class_30:
    narrator "You enter the classroom to an unexpected sight..."
    redmind thinking "Holy shit--what happened in here? The room is totally destroyed!"
    sabrina uniform @surprised "...!"
    morty uniform @surprised "Whoa."
    ...
    will @talkingmouth "Come, now; who is behind this prank? You must've enlisted Sabrina--no fledgling could wield psychic forces of {i}this{/i} power. This display is beyond even myself."
    ...
    redmind thinking "[sabrinacolor]Will, I have no idea who did this.{/color}"
    redmind thinking "Sorry, Sabrina--wrong number."
    redmind thinking "[sabrinacolor]Oh.{/color}"
    will @surprised "...What's that? You don't know a thing about it?"
...
label psychic_class_31:
    show will with dis
    will @talking2mouth "Ah... Hello, students."
    ...
    scene academyhall with splitfade
    show morty uniform with dis
    red uniform @sadbrow talkingmouth "Alright, {i}that's{/i} a little creepy. If it wasn't Sabrina--"
    redmind thinking "[sabrinacolor]It wasn't.{/color}" 
    red @talkingmouth "--then who did all that to the classroom?"
    morty @talkingmouth "'Who' isn't what I'd be asking."
    red @surprised "What do you mean?"
    morty @closedbrow talking2mouth "C'mon; you saw the state of those desks. There's only one Esper at Kobukan who could pull that off, and the prof says she didn't."
    morty @talkingmouth "Which means it's gotta be a Pokémon. Someone's Kadabra threw a tantrum and they're embarrassed to admit it."
    red @talking2mouth "I guess that could be right, but Instructor Will didn't seem to think so."
    morty @closedbrow talkingmouth "Of course he didn't. People see what they wanna see, y'know? A secret super-Esper would make his day. Probably his year."
    red @talking2mouth "Maybe..."
    morty @sleepyeyebrows sleepyeyes talkingmouth "Occam's razor, dude. For every ten ghosts people {i}think{/i} they see, nine of 'em are just bedsheets."
    morty @happy "Take that one from the expert."
    scene classroom
    show psychtype
    with splitfade
    return
...
label psychic_class_32:
    ...
    pause 0.5
    morty uniform @closedeyes "Zzzzzz..."
    pause 0.5
    will sadbrow @talking2mouth "Well, that's {i}one{/i} of you out."
...
label psychic_class_35:
    ...
    TempCharacter("???", False) "*Knock knock knock*"
...
label psychic_class_36:
    ...
    red uniform @surprised "Oh, shit."
    morty uniform @surprised "...!"
...
label psychic_class_37:
    ...
    narrator "Will forces a smile when someone else unearths the Nugget..."
    return
