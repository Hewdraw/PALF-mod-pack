...
blue @talkingmouth "That's it? Pfft. See you in a year, then."

show leaf with dis:
    xpos 1050

leaf @talking2mouth "Well, I liked it."

blue @closedbrow talking2mouth "I liked the first five days, where you weren't there."
...
ethan @talkingmouth "Guys, I think the arc of this week was meant to imply we've kinda started working as a unit. Could we cut this out?"

blue @talkingmouth "You can suck {i}my{/i} unit. I'll tolerate you guys only when we're working on something important."

leaf @flirtbrow talking2mouth "Like a bunny suit party?"

ethan @sweat talking2mouth "Do you have {i}any{/i} idea how much money and dev time went into that party? It's literally the most important part of the game."

show red behind blue with dis:
    xpos 450

red @sweat talking2mouth "Hey, uh, guys, we're getting a bit meta. Mind if I just go into the outro blurb?"
...
show mallow bunny with dis

mallow @happy "Hey, guys! I'm here for the party!"
...
mallow @sadbrow talkingmouth "Did I--did I get the time wrong...?"
